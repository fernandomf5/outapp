...
export const VideoCover = ({ videoUrl, logoUrl }: VideoCoverProps) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-[5px] rounded-[calc(var(--radius)-2px)] overflow-hidden bg-background">
      ...
      {/* Hover overlay */}
      <div className="absolute inset-[5px] rounded-[calc(var(--radius)-2px)] bg-black/0 group-hover:bg-black/10 transition-all duration-300" />
    </div>
  );
};
