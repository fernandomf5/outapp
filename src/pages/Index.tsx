  ...
  const OffCanvasMenu = ({ headerPages, onPageClick }: { headerPages: CustomPage[], onPageClick: (page: CustomPage) => void }) => (
    <Sheet>
      <SheetTrigger asChild>
        <button className="group relative inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-[#0C101B]/10 dark:bg-primary/10 hover:bg-[#0C101B]/20 dark:hover:bg-primary/20 border border-[#0C101B]/50 dark:border-primary/30 hover:border-[#0C101B]/70 dark:hover:border-primary/50 transition-all duration-300 shadow-[0_0_20px_rgba(12,16,27,0.8),0_0_40px_rgba(12,16,27,0.4)] dark:shadow-[0_0_15px_rgba(var(--primary-rgb),0.3)] hover:shadow-[0_0_30px_rgba(12,16,27,1),0_0_60px_rgba(12,16,27,0.6)] dark:hover:shadow-[0_0_25px_rgba(var(--primary-rgb),0.5)]">
          <Menu className="w-5 h-5 text-[#0C101B] dark:text-primary" />
          <span className="text-sm font-bold text-[#0C101B] dark:text-primary">Menu</span>
        </button>
      </SheetTrigger>
